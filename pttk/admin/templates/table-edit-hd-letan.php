<div style="margin: auto; width: 400px;">
	<form action="edit-list-hd-letan.php?sohd=<?php echo $sohd; ?>" method="post">	
	<h2 style="color: #FF9999; margin-left: 90px;">Sửa hóa đơn</h2>
		<div class="mb-3">
			<tr>
				...
				<td>
					<select name="makh">
						<option value="makh"><?php echo "$row[makh] - $row[tenkh]"; ?></option>
						<?php  
		...
		<div class="mb-3">
			<tr>
				...
				<td>
					<select name="manv">
						<option value="manv"><?php echo "$row[manv] - $row[tennv]"; ?></option>
						<?php  
